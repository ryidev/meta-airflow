        ...
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
          ...
          <View style={styles.titleSection}>
            <View style={styles.titleRow}>
              <Text style={styles.propertyTitle}>{property?.title || 'Entire Bromo mountain view Cabin in Suraya'}</Text>
              <TouchableOpacity>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statSubtext}>(73 reviews)</Text>
              </View>
              <View style={styles.statItem}>
                <Icon name="location-outline" size={16} color="#64748B" />
                <Text style={styles.statText}>{property?.location || 'Malang, Probolinggo'}</Text>
              </View>
              <View style={styles.statItem}>
                <Icon name="bed-outline" size={16} color="#64748B" />
                <Text style={styles.statText}>2 room</Text>
              </View>
              <View style={styles.statItem}>
                <Icon name="resize-outline" size={16} color="#64748B" />
                <Text style={styles.statText}>874 m²</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.mapContainer}>
              <Image
                source={{ uri: 'https://api.mapbox.com/styles/v1/mapbox/light-v10/static/112.7521,7.8753,12,0/600x300@2x?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw' }}
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.aboutText}>
              This cabin comes with various mountains and beautiful skiing style. You can see sunrise in the morning and feel sunrise view all the time.
            </Text>
            <Text style={styles.aboutText}>
              This villa is surrounded by luxurious district of residential. Close to cafe, top tier city life as well as wide range of culinary.
            </Text>
            <Text style={styles.aboutText}>
              This apartment equipped with Washing Machine, Electric Stove, Ref... <Text style={styles.readMore}>Read more</Text>
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.costCard}>
              ...
              <Text style={styles.costValue}>600$/month</Text>
            </View>
          </View>
